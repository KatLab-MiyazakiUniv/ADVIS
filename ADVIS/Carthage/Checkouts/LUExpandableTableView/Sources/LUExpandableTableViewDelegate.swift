...
public extension LUExpandableTableViewDelegate {
    func expandableTableView(_: LUExpandableTableView, viewForFooterInSection _: Int) -> UIView? {
        return nil
    }

    func expandableTableView(_: LUExpandableTableView, didSelectRowAt _: IndexPath) {}

    func expandableTableView(_: LUExpandableTableView, didSelectSectionHeader _: LUExpandableTableViewSectionHeader, atSection _: Int) {}

    func expandableTableView(_: LUExpandableTableView, willDisplay _: UITableViewCell, forRowAt _: IndexPath) {}

    func expandableTableView(_: LUExpandableTableView, willDisplaySectionHeader _: LUExpandableTableViewSectionHeader, forSection _: Int) {}
}
