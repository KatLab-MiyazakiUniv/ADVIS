...
//        tableView.openAll()
    ...
    @IBAction func expandMultiButtonClicked(_: Any) {
        tableView.expansionStyle = .multi
    }

    @IBAction func expandSingleButtonClicked(_: Any) {
...
extension ViewController: ExpandableDelegate {
    ...
    func expandableTableView(_: ExpandableTableView, numberOfRowsInSection section: Int) -> Int {
...
//        print("didSelectExpandedRowAt:\(indexPath)")
    ...
    func expandableTableView(_: ExpandableTableView, expandedCell: UITableViewCell, didSelectExpandedRowAt _: IndexPath) {
        if let cell = expandedCell as? ExpandedCell {
            print("\(cell.titleLabel.text ?? "")")
        }
    }

    func expandableTableView(_: ExpandableTableView, titleForHeaderInSection section: Int) -> String? {
        return "Section:\(section)"
    }

    func expandableTableView(_: ExpandableTableView, heightForHeaderInSection _: Int) -> CGFloat {
        return 20
    }
