...
class ViewController: UIViewController {
    ...
    @IBAction func showSuccess(_: AnyObject) {
    ...
    @IBAction func showError(_: AnyObject) {
...
//        SCLAlertView().showError(self, title: kErrorTitle, subTitle: kSubtitle)
    ...
    @IBAction func showEdit(_: AnyObject) {
    ...
    @IBAction func showWait(_: AnyObject) {
        let appearance = SCLAlertView.SCLAppearance(
    ...
    @IBAction func showCustomSubview(_: AnyObject) {
    ...
    @IBAction func showCustomAlert(_: AnyObject) {
        let appearance = SCLAlertView.SCLAppearance(
            kTitleFont: UIFont(name: "HelveticaNeue", size: 20)!,
            kTextFont: UIFont(name: "HelveticaNeue", size: 14)!,
            kButtonFont: UIFont(name: "HelveticaNeue-Bold", size: 14)!,
    ...
    @IBAction func showEmptySubTitleAlert(_: UIButton) {
