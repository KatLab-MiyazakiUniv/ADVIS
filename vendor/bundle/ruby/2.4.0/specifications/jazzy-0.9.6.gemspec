...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cocoapods>.freeze, ["~> 1.5.3"])
      ...
      s.add_runtime_dependency(%q<sass>.freeze, ["~> 3.6.0"])
      s.add_runtime_dependency(%q<sqlite3>.freeze, ["~> 1.3.13"])
      s.add_runtime_dependency(%q<xcinvoke>.freeze, ["~> 0.3.0"])
      s.add_development_dependency(%q<bundler>.freeze, ["~> 1.7"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10.3"])
    else
      s.add_dependency(%q<cocoapods>.freeze, ["~> 1.5.3"])
      ...
      s.add_dependency(%q<sass>.freeze, ["~> 3.6.0"])
